    ...
    <>
      <div id="features-box">
        <div className="features">
          <h1 className="features-title">Shapeshift</h1>
        ...
        <div className="features">
        <h1 className="features-title">Gather</h1>
          <img src="gather-image.png"/>
            ...
            All the ways are good and can get you far if it goes with your philosophy.
            </span>
        </div>
        <div className="features">
          <h1 className="features-title">Choose</h1>
